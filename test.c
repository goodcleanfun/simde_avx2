...
TEST test_simde_mm256_shuffle_epi8(void) {
    const struct {
        simde__m256i a;
        simde__m256i b;
        simde__m256i r;
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
        ...
        for (size_t j = 0; j < 32; j++) {
            ASSERT_EQ(((uint8_t *)&r)[j], ((uint8_t *)&test_vec[i].r)[j]);
        }
    }
    PASS();
}
...
TEST test_simde_mm256_alignr_epi8_case0(void) {
    const struct {
        simde__m256i a;
        simde__m256i b;
        simde__m256i r;
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
        ...
        for (size_t j = 0; j < 32; j++) {
            ASSERT_EQ(((int8_t *)&r)[j], ((int8_t *)&test_vec[i].r)[j]);
        }
    }
...
TEST test_simde_mm256_alignr_epi8_case1(void) {
    const struct {
        simde__m256i a;
        simde__m256i b;
        simde__m256i r;
...
TEST test_simde_mm256_alignr_epi8_case2(void) {
    const struct {
        simde__m256i a;
        simde__m256i b;
        simde__m256i r;
...
TEST test_simde_mm256_alignr_epi8_case3(void) {
    const struct {
        simde__m256i a;
        simde__m256i b;
        simde__m256i r;
...
SUITE(avx2_suite) {
    ...
    RUN_TEST(test_simde_mm256_shuffle_epi8);
    RUN_TEST(test_simde_mm256_alignr_epi8_case0);
    RUN_TEST(test_simde_mm256_alignr_epi8_case1);
    RUN_TEST(test_simde_mm256_alignr_epi8_case2);
    RUN_TEST(test_simde_mm256_alignr_epi8_case3);
}
